<%-- 
    Document   : Principal
    Created on : 2/03/2020, 01:09:40 PM
    Author     : Mary
--%>
     ...
     <div class="wrap">
            <ul class="menu">
                <ul>
                    ...
                    <li class="submenu"><a class="sub" href="#"><strong>Catálogos</strong></a>
                        <ul>
                            <li><a href="Controlador?menu=Catalogos&accion=Listar" target="myMarco">Agregar catálogo</a></li> 
                            <%--<li><a href="ControladorCatalogos?menu=Catalogo&accion=Listar" target="myMarco">Agregar catálogo</a></li> --%>
                            </ul>
                    </li>  
